...
class RERASelectedViewListPage extends KFDrawerContent {

  var title,num,userToken;
  var color,projectData;
  RERASelectedViewListPage(title,num,userToken, Color color,projectData){
    this.title = title;
    this.num = num;
  ...
  @override
  RERASelectedViewListPageState createState() => RERASelectedViewListPageState(title,num,userToken,color,projectData);
}

class RERASelectedViewListPageState extends State<RERASelectedViewListPage> {

  var title,num,userToken;
  var color,projectData;
  RERASelectedViewListPageState(title,num,userToken,color,projectData){
    this.title = title;
    this.num = num;
    this.userToken = userToken;
    this.color = color;
                    ...
                    return  InkWell(
                      onTap: ()async {
                        final result = await Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => new ReraFillPage(userToken,reraCollection[index],1)));
                         if(result != null){
                           getChecklistCollection(context);
                        }
                      },
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(reraCollection[index]['project_name'],
                                          style: TextStyle(
                                            fontSize: 1.8 *
                                                SizeConfig.textMultiplier,
                                            fontFamily: 'Lato',
                                      ...
                                      Text(reraCollection[index]['building_name'],
                                          style: TextStyle(
                                            fontSize: 1.8 *
                                                SizeConfig.textMultiplier,
                                            fontFamily: 'Lato',
                                      ...
                                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text("Stage ${reraCollection[index]['stage_no']}",
                                              style: TextStyle(
                                                fontSize: 1.8*
                                                    SizeConfig.textMultiplier,
                                                fontFamily: 'MyriadPro',
                                              )),
                                          Text(reraCollection[index]['completion_date'] != null?"${ApiClient.dataFormatYear(reraCollection[index]['completion_date'])}":"",
                                              style: TextStyle(
                                                fontSize: 1.8*
                                                    SizeConfig.textMultiplier,
                                                fontFamily: 'MyriadPro',
                  ...
                  child: Column(children: [
                    ...
                    Text("RERA",
                        ...
                        style: TextStyle(
                          ...
                          fontFamily: 'Lato',)),
                    SizedBox(height: 1 * SizeConfig.heightMultiplier,),
                    Text("There is no any RERA data found",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.black,
  ...
  getChecklistCollection(BuildContext context) async{
    var url = Uri.parse(ApiClient.BASE_URL+"status_wise_rera_records");
    Map map ={
    ...
    print("URL : ${ApiClient.BASE_URL+"status_wise_rera_records"}");
    print("map : ${map}");
