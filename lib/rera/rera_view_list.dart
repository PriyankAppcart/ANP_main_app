...
class ReraViewListPage extends KFDrawerContent {
  var userToken, projectData;
  ReraViewListPage(userToken, projectData) {
    this.userToken = userToken;
    this.projectData = projectData;
  }

  @override
  ReraViewListPageState createState() =>
      ReraViewListPageState(userToken, projectData);
}

class ReraViewListPageState extends State<ReraViewListPage> {
  var userToken, projectData;
  ReraViewListPageState(userToken, projectData) {
    this.userToken = userToken;
    this.projectData = projectData;
            ...
            child: internetConnection
                    ...
                    ? apiFlag
                        ? SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          getSelectedList(context, "Approved",
                                              3, Colors.green);
                                        },
                                        child: Row(
                                          children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          getSelectedList(context, "Revoked", 5,
                                              Colors.red);
                                        },
                                        child: Row(
                                          children: [
                                ...
                                reraCollection.length >= 1
                                    ? ListView.builder(
                                        scrollDirection: Axis.vertical,
                                        padding: EdgeInsets.zero,
                                        shrinkWrap: true,
                                        physics: ScrollPhysics(),
                                        itemCount: reraCollection.length,
                                        itemBuilder:
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                    "Stage ${reraCollection[index]['stage_no']}",
                                                                    style:
                                                                        TextStyle(
                                                                      fontSize: 1.8 *
                                                                          SizeConfig
                                                                ...
                                                                Text(
                                                                    "${ApiClient.dataFormatYear(reraCollection[index]['completion_date'])}",
                                                                    style:
                                                                        TextStyle(
                                                                      fontSize: 1.8 *
                                                                          SizeConfig
                                    ...
                                    : Container(
                                        ...
                                        child: Column(children: [
                                          ...
                                          Text(
                                              "There is no any project RERA data",
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 2 *
                        ...
                        : Container(
                            ...
                            child: Column(children: [
                              ...
                              Text("There is no any project RERA data",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 2 * SizeConfig.textMultiplier,
                ...
                : Center(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/icons/connection_off.png',
                      ...
                      Text(
                          "Keep calm  and press the refresh button to try again.",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 2.2 * SizeConfig.textMultiplier,
        ...
        child: FloatingActionButton(
          ...
          onPressed: () async {
            final result = await Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        new ReraFillPage(userToken, projectData, 0)));
            if (result != null) {
              getReraCollection(context);
            }
          },
  ...
  Future<void> getSelectedList(
      BuildContext context, String title, int i, Color color) async {
    final result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => new RERASelectedViewListPage(
                title, i, userToken, color, projectData)));
  ...
  getReraCollection(BuildContext context) async {
    var url = Uri.parse(ApiClient.BASE_URL + "get_rera_collection");
    Map map = {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      if (decoded['status']) {
        setState(() {
          ...
          total = decoded['total_rera'];
          in_progress_count = decoded['in_progress_rera_count'];
          submitted_count = decoded['submitted_rera_count'];
          approved_count = decoded['approved_rera_count'];
          rejected_count = decoded['rejected_rera_count'];
          revoked_rera_count = decoded['revoked_rera_count'];
