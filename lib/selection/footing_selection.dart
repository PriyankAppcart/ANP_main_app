...
class FootingSelection extends StatelessWidget {
                                    ...
                                    children: <
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text("${footingList[index]['footing_name']}",
                      ...
                      MaterialButton(
                        ...
                        onPressed: () async {
                          ...
                          for(int i = 0; i< isColumns.length; i++){
                            if(isColumns[i]){
                              setState(() {
                                selectedName +=  footingList[i]['footing_name'] +" ";

                              });
                              print("flatList id :: ${isColumns.length}");
                              Map map = {
                                "footing_name": footingList[i]['footing_name'],
                                "footing_id": footingList[i]['id']
                              };
                              footingMap.add(map);
                            }
