  ...
  Widget dialogContent(BuildContext context) {
    ...
    padding: EdgeInsets.zero,
        ...
        itemBuilder:
            ...
            int index) {
          return reportingUnit == "FLAT"?
          floorList[index]['floor_category'] == 1?Container(
              child: GestureDetector(
                onTap: () {
                  onSelected(floorList[index]['floor_name'],floorList[index]['id']);
                  ...
                  child: Column(
                    ...
                    children: <
                     ...
                     // SizedBox(height:SizeConfig.heightMultiplier,),
                      Text("${floorList[index]['floor_name']} ",
